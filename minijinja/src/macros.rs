...
/// ```
///
/// The merge works with any value, not just [`Value`](crate::value::Value)s created by the [`context!`](crate::context!)
/// macro and is performed lazily.  This means it also works with dynamic
